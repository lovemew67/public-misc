...
type Staff struct {
	...
	Email string `protobuf:"bytes,5,opt,name=email,proto3" json:"email,omitempty" bson:"email,omitempty" gorm:"column:email"`
	// @inject_tag: json:"avatar_url,omitempty" bson:"avatar_url,omitempty" gorm:"column:avatar_url"
	AvatarUrl string `protobuf:"bytes,6,opt,name=avatar_url,json=avatarUrl,proto3" json:"avatar_url,omitempty" bson:"avatar_url,omitempty" gorm:"column:avatar_url"`
}
...
var file_staff_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x94, 0x01, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x66, 0x66, 0x12, 0x0e,
	...
	0x52, 0x09, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x55, 0x72, 0x6c, 0x42, 0x09, 0x5a, 0x07, 0x2e,
