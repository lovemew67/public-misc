...
func (x *StaffV1) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *StaffV1) GetAvatarUrl() string {
	if x != nil {
		return x.AvatarUrl
	}
	return ""
...
var file_staff_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x01, 0x0a, 0x07, 0x53, 0x74, 0x61, 0x66, 0x66, 0x56, 0x31,
	...
	0x28, 0x09, 0x52, 0x09, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x55, 0x72, 0x6c, 0x42, 0x09, 0x5a,
